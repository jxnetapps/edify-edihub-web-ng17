...
@Injectable()
export class AppDBkeys {

	public static readonly CURRENT_USER_ID = 'userId';
	...
	public static readonly DEFAULT_ACADEMICYEARID = 'defaultAY';
	public static readonly CURRENT_USER_ROLE = 'user_type';
}
