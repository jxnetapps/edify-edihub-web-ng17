...
export class UserEffects {
    ...
    loadUsersPage$: any = createEffect((): any =>
    ...
    deleteUser$: any = createEffect((): any => this.actions$
        .pipe(
    ...
    updateUser$: any = createEffect((): any => this.actions$
        .pipe(
    ...
    createUser$: any = createEffect((): any => this.actions$
        .pipe(
