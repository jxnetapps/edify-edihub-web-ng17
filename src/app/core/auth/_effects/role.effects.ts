...
export class RoleEffects {
    ...
    loadAllRoles$: any = createEffect((): any => this.actions$
        .pipe(
    ...
    loadRolesPage$: any = createEffect((): any => this.actions$
        .pipe(
    ...
    deleteRole$: any = createEffect((): any => this.actions$
        .pipe(
    ...
    updateRole$: any = createEffect((): any => this.actions$
        .pipe(
    ...
    createRole$: any = createEffect((): any => this.actions$
        .pipe(
